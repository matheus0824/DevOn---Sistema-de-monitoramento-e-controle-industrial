    ...
    <section class="secao-planos" id="planos">
        ...
        <div class="container-planos">
            ...
            <div class="card-plano destaque">
                <h3 class="nome-plano">Ouro</h3>
                <div class="preco-plano">R$ 299,90<span>/mês</span></div>
                <ul class="recursos-plano">
                    <li>Gestão de equipamentos</li>
                    <li>Controle de processor</li>
                    <li>Manutenção mensal</li>
            ...
            <div class="card-plano">
                <h3 class="nome-plano">Platina</h3>
                <div class="preco-plano">R$ 379,90<span>/mês</span></div>
                <ul class="recursos-plano">
                    <li>Gestão de equipamentos</li>
                    <li>Controle de processor</li>
                    <li>Manutenção mensal</li>
                ...
                <a href="pacotes.php"><button class="botao-plano">Assinar Agora</button></a>
